...
const Login = () => {
    ...
    return (
        <div>
            ...
            <form onSubmit={getInputData} className='flex flex-col  lg:w-4/12 p-12 my-36 left-0 right-0  mx-2 md:mx-auto items-center justify-center absolute rounded-md bg-black opacity-90'>
